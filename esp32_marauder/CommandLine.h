...
const char PROGMEM ATTACK_TYPE_TK[] = "small-bag";
...
// WiFi attack
const char PROGMEM HELP_ATTACK_CMD[] = "attack -t <beacon [-l/-r/-a]/deauth [-c]/[-s <src mac>] [-d <dst mac>]/probe/rickroll/small-tik>";
